    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('courses.exams.index', $course) }}">{{ $course->name }}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">إضافة امتحان جديد</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body p-4">
                <h5 class="mb-4">إضافة امتحان : {{ $course->name }}</h5>
                <form method="POST" action="{{ route('courses.exams.store', $course) }}" class="row g-3">
                    @csrf
