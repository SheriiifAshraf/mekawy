            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">إضافة كورس جديد</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('courses.store') }}" enctype="multipart/form-data" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="price" class="form-control" id="input3" placeholder="">
                    </div>

                    <div class="col-md-6">
                        <label for="input11" class="form-label">محتوي الكورس</label>
                        <textarea class="form-control" name="description" id="input11" placeholder="" rows="3"></textarea>
                    </div>
